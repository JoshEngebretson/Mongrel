...
//**	   #    ##    ##    #      ####     ####   ##       ##
//**
//**	$Id: d3d_main.cpp 4428 2011-09-03 14:41:19Z firebrand_kh $
//**
...
void VDirect3DDrawer::SetFade(vuint32 NewFade)
{
	...
	if (NewFade)
	{
		...
		if (NewFade == FADE_LIGHT)
		{
			...
			RenderDevice->SetRenderState(D3DRS_FOGEND, PassFloat(1024.0 * r_fade_factor));
		}
		else
		{
...
bool VDirect3DDrawer::SupportsAdvancedRendering()
{
	return false;
}
